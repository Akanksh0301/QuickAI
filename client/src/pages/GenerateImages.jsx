...
const GenerateImages = () => {
    ...
    const imageStyle=[
      ...
      const onSubmitHandler=async(e)=>{
        ...
        try{
            setLoading (true);
            const prompt =`Generate an image with ${input} in ${selectedStyle} style.`;
    ...
    text-slate-700'>
      ...
      border-gray-200'>
       ...
       Describe Your Image
        ...
        border-gray-300' 
        placeholder='Describe what you want to see in the Image in detail...' required />
...
<div className='my-4 flex items-center gap-2'>
  <label className='relative cursor-pointer' >
    ...
    <div className='w-9 h-5 bg-slate-300 rounded-full peer-checked:bg-green-500 transition'>  
      ...
      peer-checked:translate-x-4 transition'></span> 
  </label>
  ...
  {loading ? <span className='w-4 h-4 my-1 rounded-full border-2 border-t-transparent animate-spin'>
   ...
   Generate Image
      ...
      {/*right column*/}
        ...
        <div className='w-full max-w-lg p-4 bg-white rounded-lg border
        border-gray-200 flex flex-col min-h-96 '>
          <div className='flex items-center gap-3'>
