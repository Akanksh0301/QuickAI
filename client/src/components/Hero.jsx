...
const Hero = () => {
  ...
  <div className='text-center mb-6'>
    ...
    <p className='mt-4 max-w-xs sm:max-w-lg 2xl:max-w-xl m-auto max-sm:text-xs text-gray-600'>transform your content with our suite of premium ai tools.
        Write articles,generateimages,and enhance your workflow </p>
  </div>
  <div className='flex flex-wrap justify-center gap-4 text-sm max-sm:text-xs'>
    <button onClick={ () => navigate('/ai')} className='bg-blue-600 text-white 
    px-10 py-3 rounded-lg hover:scale-102 active:scale-95
