...
const{getToken}=useAuth();
    ...
    formData.append("object", object); // must match upload.single('image')

    const { data } = await axios.post(
      "/api/ai/remove-image-object",
      formData, // ✅ SEND DIRECTLY, NOT {formData}
      {
        headers: {
  ...
  return (
   <div className='h-full overflow-y-scroll p-6 flex items-start flex-wrap gap-4
    text-slate-700'>
      ...
      className='w-full max-w-lg p-4 bg-white rounde-lg border
      border-gray-200'>
